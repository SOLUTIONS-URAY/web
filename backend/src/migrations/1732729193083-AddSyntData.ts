...
export class AddSyntData1732729193083 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`INSERT INTO "ticket_type" ("name") VALUES ('Обслуживание')`);
        await queryRunner.query(`INSERT INTO "ticket_type" ("name") VALUES ('Инциденты / Аварии')`);
        await queryRunner.query(`INSERT INTO "ticket_type" ("name") VALUES ('Изменение состояния')`);
