...
import {TelegramMatch} from "./models/TelegramMatch";
import {AddTelegramMatch1732955679755} from "./migrations/1732955679755-addTelegramMatch";
...
export const typeOrmConfig: DataSourceOptions = {
    ...
    entities: [Ticket, TicketEvent, User, Organization, TicketType, TelegramMatch],
    subscribers: [],
    synchronize: false,
    logging: true,
